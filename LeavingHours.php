...
if(isset($_POST['ldate']) and isset($_POST['lhour']))  {
	$ldate = $_POST['ldate'];
	$lhour= $_POST['lhour'];
	...
	mysqli_select_db($link, $database) or die( "Unable to select database");
     ...
     $sql_query = "SELECT Username from leaving_hours AS LH where LH.Username = '$username'"; 
...
$result = mysqli_query ($link, $sql_query)  or die(mysqli_error($link));  
	...
	$username_check = $row['Username'];
     if ($username_check) 
    {       
            $sql_query2 = " UPDATE leaving_hours AS LH SET LH.Ldate ='$ldate', LH.Lhour='$lhour' where LH.Username='$username' ";
     ...
     $sql_query3 = "INSERT INTO leaving_hours(Username, LDate, LHour) VALUES ('$username', '$ldate','$lhour') ";
...
<tr>
<td align="center" colspan="2"><p class="heading4">Leaving Hours</p></td>
</tr>


  <tr>
    <td>Date</td>
    <td><input type="text" name="ldate" value="<?php echo date('d/m/y');?>"/></td>
 </tr>

 <tr>
    <td>Hour</td>
    <td><input type="text" name="lhour" value=" <?php echo date('h:i:sa');?>"/></td>
 </tr>
<tr></tr>
