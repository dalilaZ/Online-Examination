...
<nav>
  ...
  <div class="nav-wrapper" style="color: #f3f4f5;">
    ...
    <ul class="right hide-on-med-and-down">
      ...
      <li><a class="dropdown-button" href="#!" data-activates="dropdown1">Welcome  <?php echo $_SESSION['username']; ?>
...
while($s--){
  ...
  ?>  <form method="post"><div class="row">
        ...
        <button class="btn waves-effect waves-light" type="submit" value="Delete" name="Delete">Delete
      </button>
    </div> </form>
	<?php
...
$x++;
	...
	<div class="input-field col s12">
	 <textarea id="textarea1" class="materialize-textarea" name="id2" required></textarea>
          <label for="textarea1">Question No</label>
      </div>
        <div class="input-field col s12">
