...
$email=$_POST['email'];
$query = mysqli_query($connect,"SELECT user from student where user='$user'");
$sc=mysqli_num_rows($query); 

$query2 = mysqli_query($connect,"SELECT username from teacher where username='$user'");
$tc=mysqli_num_rows($query2); 
...
header("Location:login.php");
	...
	mysqli_query($connect," INSERT INTO teacher VALUES('$user','$password','$name','$lname','$email')");
header("Location:login.php");
}
}
}
