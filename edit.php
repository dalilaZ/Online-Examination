          ...
          <div class="">
            <div class="page-title">
			  ...
			  <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                $xyz1=mysqli_query($connect,"SELECT *  from exam_question where exam_id='$exam_id' AND username='$name' ");
              $i1=mysqli_num_rows($xyz1);
			  while($i1=mysqli_fetch_array($xyz1)){
			  $question_id = $i1['question_id'];
              $xyz=mysqli_query($connect,"SELECT *  from questions where  no='$question_id'  ORDER BY no ASC");
			 ...
			 ?>
					    ...
					    <tr>
                          <td><?php echo "<a href=edit2.php?question_id=$question_id>Edit Question</a>"; ?></td>
                          <td><?php echo $x; ?></td>
                          <td><?php echo $ques; ?></td>
