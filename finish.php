...
$result = mysqli_query ($link, $sql_query)  or die(mysqli_error($link));  
	...
	$username_check = $row['Username'];
     if ($username_check) 
    {       
            $sql_query2 = " UPDATE lunch AS L SET L.Finish ='$fhour' where L.Username='$username' ";
     ...
     $sql_query3 = "INSERT INTO lunch(Username, Finish) VALUES ('$username', '$fhour') ";
...
<tr>
<td align="center" colspan="3"><p class="heading4">Finished</p></td>
</tr>


  <tr>
    <td>Start</td>
    <td><input type="text" name="fhour" value=" <?php echo date('h:i:sa');?>"/></td>
 </tr>
<tr></tr>
